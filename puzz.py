...
class EightPuzzleBoard:
    ...
    # return an individual tile value
    ...
    def _set_dir(self, way):
        self.dir = way

    def _set_par(self, node):
        self.prev = node

    # create a successor object (or None if invalid)
    def _create_successor(self, delta_x, delta_y):  
